        ...
        <div class="col-md-8 col-sm-8 col-xs-8">
            ...
            <div class=" col-md-10 col-xs-10 col-sm-10 contenedorTargetas">
                ...
                <%
                    ...
                    List<Postulante> lstps=daop.getSeguidos(Integer.parseInt(sesion.getAttribute("idPostulante").toString()));
                    
                     for(Postulante po: lstps)
                     {
                %>
                
                    <li class="collection-item avatar">
                        <img src="data: image / jpg; base64, <%= po.getBase64Image() %>" alt="" class="circle">
                        <a class="verPerfil" id="<%=po.getIdPostulante() %>" href="#"><span class="title"><%=po.getNombres() %>&nbsp;<%=po.getApellidos() %></span></a>
                        <p><%=po.getCorreo()%><br>
                            Second Line
                        </p>
